...
def play_game() -> None:
    ...
    while check_won(board) == '' and have_space(board):
        ...
        player_selected_move = int(input('Player ' + current_player + ', select a move: '))
